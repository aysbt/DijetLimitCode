...
Transfer_Input_Files = stats, Data_and_ResonanceShapes/histo_data_mjj_fromTree_22_07_15_37_invpb.root, Data_and_ResonanceShapes/ResonanceShapes_gg_13TeV_PU30_Spring15.root, Data_and_ResonanceShapes/ResonanceShapes_qg_13TeV_PU30_Spring15.root, Data_and_ResonanceShapes/ResonanceShapes_qq_13TeV_Phys14Spring15Mix.root, $ENV(HOME)/lib/libBAT.so.5, $ENV(HOME)/lib/libBATmodels.so.3, $ENV(HOME)/lib/libBATmtf.so.0
