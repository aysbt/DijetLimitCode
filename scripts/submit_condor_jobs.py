...
Transfer_Input_Files = stats, Data_and_ResonanceShapes/hist_data_Run2012all_21nov.root, Data_and_ResonanceShapes/Resonance_Shapes_DUMMY_FS_Pythia8.root, $ENV(HOME)/lib/libBAT.so.5, $ENV(HOME)/lib/libBATmodels.so.3, $ENV(HOME)/lib/libBATmtf.so.0
